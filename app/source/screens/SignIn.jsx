import {Text, KeyboardAvoidingView, StyleSheet, View, TextInput, TouchableOpacity, Keyboard, TouchableWithoutFeedback, Platform } from 'react-native'
...
function SignInScreen({ navigation }) {
    ...
    function onSignIn(){ 
        ...
        // Break out of this function if there were any issuses
        ...
        API({
            ...
            utils.log('Sign In Response:', response.data)
            const credentials = {
                username: username,
                password: password
            } 
            ...
            <KeyboardAvoidingView behavior = "height" style={{ flex: 1 }}>
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.main}>
                        ...
                        <Input title='Password' value={password} error={passwordError} setValue={setPassword} setError={setPasswordError} secureTextEntry={true} />
